...
from agents.ppo_ep_counts import PPOAlgoEpisodicCounts
...
def main():
    ...
    if args.algo == "ppo-ep-counts":
        algo = PPOAlgoEpisodicCounts(envs, acmodel, device, args.frames_per_proc, args.discount,
                                     ...
                                     args.batch_size, args.lr_anneal_frames, preprocess_obss,
