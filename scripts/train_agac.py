...
from model import ACModel, PolicyPredictor

from agents.ppo_agac import PPOAlgoAGAC
...
def main():
    ...
    predictor = PolicyPredictor(obs_space, envs[0].action_space, 
                                args.mem, use_pano_obs=args.pano_obs)
    ...
    if args.algo == "ppo-agac":
        algo = PPOAlgoAGAC(envs, acmodel, device, args.frames_per_proc, args.discount,
                          ...
                          episodic_count_coef=args.episodic_count_coef)
    ...
    while num_frames < args.frames:
        ...
        if update % args.log_interval == 0:
            ...
            if 'agac' in args.algo:
                ...
                header += ["mean_intrinsic_values_batch", "min_intrinsic_values_batch",
                          "max_intrinsic_values_batch", "std_intrinsic_values_batch"]

                data += [logs["mean_intrinsic_values_batch"], logs["min_intrinsic_values_batch"],
                        logs["max_intrinsic_values_batch"], logs["std_intrinsic_values_batch"]]
