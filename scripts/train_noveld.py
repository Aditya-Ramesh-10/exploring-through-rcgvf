...
from agents.ppo_noveld import PPOAlgoNovelD
...
def main():
    ...
    if args.algo == "ppo-noveld":
        algo = PPOAlgoNovelD(envs, acmodel, device, args.frames_per_proc, args.discount,
                          ...
                          ir_scale_alpha=args.ir_scale_alpha)
